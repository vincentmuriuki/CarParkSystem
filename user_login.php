...
if (isset($_POST['submit'])) {
  ...
  if (empty($email) || empty($password) ) {
	...
	$_SESSION['user_address']=$f['address'];
  	...
  	echo "<script>window.alert('Wrong details');</script>";
  }
}
}
?>
...
<div class="alignc">
<div class="h"><legend>ENTER YOUR LOGIN DETAILS HERE.</legend></div>
<br><br>
...
<div class="form-group has-feedback">
 ...
 <script>
 	function myFunction(){
 		var em=document.getElementById('in').value;
 		var ps=document.getElementById('in2').value;
